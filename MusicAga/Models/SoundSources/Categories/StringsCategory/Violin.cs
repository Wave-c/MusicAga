...
namespace MusicAga.Models.SoundSources.Categories.StringsCategory
{
    internal class Violin : Strings
    {
        ...
        public Violin(bool includeBow, bool fineTuners, bool flamedBack, bool fineTuningScreForEString, string body, string fretbboard, string name, string brand, decimal price, string type, int year) : base(body, fretbboard, name, brand, price, type, year)
        {
